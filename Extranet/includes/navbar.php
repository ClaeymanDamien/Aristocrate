                ...
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown text-center">
                        ...
                        <div class="dropdown-menu text-center" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/films-a-l-affiche.php">A l'affiche</a>
                            <a class="dropdown-item" href="/films-a-l-affiche.php#prochainement">Prochainement</a>
                            <a class="dropdown-item" href="/films-a-l-affiche.php#evenement">Évènement</a>
                        </div>
                    <li class="nav-item text-center">
                        <a class="nav-link" href="/horaires.php">Horaires</a>
                    </li>
                    <li class="nav-item text-center">
                        <a class="nav-link" href="/prochainement.php">Offres</a>
                    </li>
                    <li class="nav-item text-center">
                    ...
                    if(!empty($userSession)){
                        ...
                        <li class="nav-item">
                            <a href="/profil.php" class="text_decoration_none">
                                <button class="btn btn-danger btn-block pr-3 pl-3">
                                    Mon Profil
                                </button>
                            </a>
                        </li>
