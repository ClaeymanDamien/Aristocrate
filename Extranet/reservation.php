...
<div class="container-fluid m-0 p-0 height-80-vh">
    ...
    if(empty($userSession)){
        ?>
        <div class="col-12 offset-md-2 col-md-8 offset-lg-3 col-lg-6 p-4">
            <div class="d-flex justify-content-center align-items-center height-80-vh">
                <span class="h1">Veuillez-vous connecter pour pouvoir réserver.</span>
            </div>
        </div>
       <?php
    }
        ...
        if (isset($_POST['payerchoice'])) {
            ...
            <div class="col-12 m-0 p-0 mt-4">
                ...
                <div class="col-12 mt-5 m-0 p-0 text-center text-justify">
                    <span class="h3">Vous pourrez retrouver votre billet sur votre profil.</span>
                </div>
        ...
        elseif (isset($_POST['daychoice'])){
            ...
            <form action="/reservation.php" enctype="multipart/form-data" method="post">
                <div class="form-group">
                    <label for="timechoice">Choix du jour :</label>
                    <select class="form-control" id="timechoice" name="time">
                        <?php
                        $reqTime = $managerSeance->selectDaySeances(htmlspecialchars($_SESSION['idFilmReservation']),htmlspecialchars($_SESSION['dayFilmReservation']));
